...
import { PcModel } from '../../public/models/Gaming-pc'
import { OrbitControls } from '@react-three/drei'
import { AboutQuotes, bentoSocialLinks } from '../constants'
            ...
            <div className='md:col-span-7 col-span-12 row-span-5'>
              ...
              >
                <div className='flex items-center gap-4'>
                  <img src="/images/profile.jpg" alt='profile' className='md:w-24 w-16 flower rounded-full' />
